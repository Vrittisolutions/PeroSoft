...
public class DSRGetOtherExpActivity extends Activity implements OnClickListener{
	Context parent;
						  ...
						  new DialogInterface.OnClickListener() {
							...
							// get user input and set it to result
						    	...
						    	if(Acno!=null&&AcType!=null){
						    		databaseHelper.UpdateOtherExpTable(TId, Acno, Name, AcType, Amount, Narration);
	...
	public void onClick(View v) {
		...
		case R.id.btnbankdepo:
			...
			PetroSoftData.OTHER_EXP = splitDatabyspace(data);
			Intent intent = new Intent();
			setResult(PetroSoftData.REQUEST_GET_OTHER_EXP_DETAILS_FOR_DSR,
					intent);
			finish();
			break;
							  ...
							  new DialogInterface.OnClickListener() {
								...
								// get user input and set it to result
							    	...
							    	if(editTextAccName.getText().toString().equalsIgnoreCase("")){
							    		...
							    		getAcCode(Name);
							    		if(Acno!=null&&AcType!=null){
							    		databaseHelper.AddOtherExpTable(Acno, Name, AcType, Amount, Narration);
	...
	public void onBackPressed() {
		...
		PetroSoftData.OTHER_EXP = splitDatabyspace(data);
		Intent intent = new Intent();
		setResult(PetroSoftData.REQUEST_GET_OTHER_EXP_DETAILS_FOR_DSR,intent);
		finish();
	}
	...
	private boolean dbvalue() {
		try {
			...
			Cursor cursor = sql.rawQuery("SELECT * FROM OtherExpTable", null);
	...
	public void updatelist() {
		...
		if (c.getCount()>0){
			...
			btnbankdepo.setText("Other Exp:   "+ money);
			c.close();
			db.close();
			db1.close();
		}
	...
	private void initViews() {
		// TODO Auto-generated method stub
		parent = DSRGetOtherExpActivity.this;
		...
		btnbankdepo.setText("Other Exp: "+PetroSoftData.OTHER_EXP);
