...
public class DSRGetCashierActivity extends Activity {
	...
	private void initialize() {
		parent = DSRGetCashierActivity.this;
...
//		if (NetworkUtilities.isInternetAvailable(parent))
//			refreshList();
//		else
...
//		Collections.sort(nameList, String.CASE_INSENSITIVE_ORDER);
		//	String[] items1 = nameList.toArray(new String[nameList.size()]);
			 adapter = new ArrayAdapter<String>(DSRGetCashierActivity.this,
	...
	private void updateList() {
		...
		Cursor c2 =db.rawQuery(
				"SELECT Name FROM CashierMaster where AcType='Cashier' ",null);
